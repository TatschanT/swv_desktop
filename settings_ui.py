...
FIELDS = [
    ...
    ("PhysicalConfig", "MIN_FREQ",          "Min frequency (Hz)",        _FLOAT, 10.0, 100.0, 0, 5.0),
    ("PhysicalConfig", "MAX_FREQ",          "Max frequency (Hz)",        _FLOAT, 101.0, 501.0, 0, 5.0),
    ("SimResolution",  "FREQ_1D_STEP",      "Freq response step (Hz)",   _INT,   1, 10),
